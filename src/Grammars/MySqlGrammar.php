...
use Hyperf\Database\Query\Grammars\MySqlGrammar as Base;
use PDO;
...
class MySqlGrammar extends Base implements JsonGrammar {
     ...
     * @return bool
     */
    public function supportsMemberOf(ConnectionInterface|\Illuminate\Database\ConnectionInterface $connection): bool {
